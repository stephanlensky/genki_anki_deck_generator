...
gdown.download(
    id="1RXnr3nEiv5gFGIQqdMugrETwXu-lsar1",
    output="./data/genki_1/sound/genki_1_sounds.zip",
)
...
gdown.download(
    id="1KPkNM85bM4zymzqO-aLWELah-RVM2p3O",
    output="./data/genki_2/sound/genki_2_sounds.zip",
)
